<%@ Page   EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckPoint.aspx.cs" Inherits="BST_DASHBOARD.Project.CheckPoint" %>
               ...
               <UpdatedControls>
                 ...
                 <Columns>
                     <telerik:GridTemplateColumn HeaderText="#" UniqueName="RowNumber" >
                        ...
                        <telerik:GridBoundColumn DataField="DoorNumberText" HeaderText="ประตู" UniqueName="DoorNumberText"
                         >
                                <HeaderStyle Width="20%" />
                            </telerik:GridBoundColumn>
